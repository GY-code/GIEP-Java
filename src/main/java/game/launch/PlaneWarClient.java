...
import client.ui.PlatformGUI;
import client.utils.SendScores;
import game.constant.Constant;
import game.core.Background;
import game.core.EnemyPlane;
import game.core.Explode;
import game.core.Item;
import game.core.Missile;
import game.core.MyFrame;
import game.core.Plane;
import game.util.ImageUtil;
import game.util.MusicUtil;
	...
	public void launchFrame() {
		...
		super.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				if(myPlane!=null) {
					int score=myPlane.getScore();
					if(score!=0) {
						SendScores.sendScores2Server(score);
